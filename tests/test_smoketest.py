...
class TestSmoketest():
  ...
  def test_adminPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("fedf")
    self.driver.find_element(By.ID, "password").send_keys("srdsd")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("ACHO")
    self.driver.find_element(By.NAME, "lname").send_keys("YATTE")
    self.driver.find_element(By.NAME, "bizname").send_keys("OPEN")
    self.driver.find_element(By.NAME, "biztitle").send_keys("OPEN")
